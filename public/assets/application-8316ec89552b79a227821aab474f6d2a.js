...
(function() {
  $(function() {
    ...
    $(window).resize(function() {
      ...
      return $('body').css('height', $(this).height() - 20);
    });
    $('#need_text').focus();
    $('.item:not(.completed)').settings();
    return $('.complete_doing').click(function() {
      return $(this).complete_doing();
    });
  });

  $.fn.update_doing = function(text) {
    ...
    return $(this).parent('.edit').hide();
  };

  $.fn.complete_doing = function() {
    return $.ajax($(this).parent().parent().attr('id'), {
      type: 'PATCH',
      data: {
  ...
  $.fn.settings = function() {
    $(this).hover(function() {
      return $(this).css('background-color', '#f6f6f6');
    });
    ...
    $(this).find('.text').click(function() {
      ...
      return edit.find('textarea').focusout(function() {
        return $(this).update_doing($(this).val());
      });
    });
    $(this).find('textarea').autogrow();
    return $(this).find('textarea').keydown(function(event) {
